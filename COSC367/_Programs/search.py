...
Artificial Intelligence. Most of the code here is abstract.  The
...
def generic_search(graph, frontier):
    ...
    for starting_node in graph.starting_nodes():
        ...
        # first arc on each path is a dummy arc to a starting node
...
class ExplicitGraph(Graph): #consider becoming a subclass of LocationGraph
